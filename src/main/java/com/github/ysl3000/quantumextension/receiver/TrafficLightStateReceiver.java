...
public class TrafficLightStateReceiver extends AbstractStateReceiver {
    ...
    public static final ReceiverState ON = ReceiverState.getByWool(Material.GREEN_WOOL);
    public static final ReceiverState OF = ReceiverState.getByWool(Material.RED_WOOL);
